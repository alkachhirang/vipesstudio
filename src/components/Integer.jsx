            ...
            <div className='container mx-auto xl:max-w-[1320px] md:px-6 px-4'>
                ...
                <div className='flex flex-row flex-wrap '>
                    <div className='lg:w-1/3 lg:pr-[32px] w-full'>
                        <div className='sm:px-[38px] px-[28px] pt-[50px] sm:pt-[60px] hover:border-transparent cursor-pointer border border-[#0000001a] rounded-[16px] h-full flex flex-col justify-between hover:shadow-[0_20px_60.571px_rgba(229,_233,_246,_1)] transition-all duration-300 ease-linear '>
